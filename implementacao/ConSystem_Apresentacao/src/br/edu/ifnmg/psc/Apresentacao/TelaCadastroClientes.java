...
public class TelaCadastroClientes extends javax.swing.JInternalFrame{
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            else JOptionPane.showMessageDialog(rootPane, "Dados de Cadastro Inválidos","Mensagem de Erro",JOptionPane.ERROR_MESSAGE);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(JOptionPane.showConfirmDialog(rootPane, "Deseja realmente excluir Cliente?") == 0){
            ...
            else JOptionPane.showMessageDialog(rootPane,"Mensagem de Erro","Ocorreu um erro durante a execução!\n"
