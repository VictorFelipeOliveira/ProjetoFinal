...
import static br.edu.ifnmg.psc.Apresentacao.TelaPrincipal.DesktopPrincipal;
...
public class TelaEfetuarVenda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        spinQuantidade.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        ...
        btnRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/removeItem.png"))); // NOI18N
    ...
    private void BtnFinalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnFinalActionPerformed
        try {
            if(verificaCampos()){
                extraiCampos();
                if(JOptionPane.showConfirmDialog(rootPane, "Deseja realmente Efetuar a Venda?") == 0){
                    preencheObjeto();
    ...
    private void btnDescontoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDescontoActionPerformed
        ...
        else if(txtValorTotal.getText().equals("")||txtDesconto.getText().equals("") || txtValorTotal.getText().isEmpty())
            JOptionPane.showMessageDialog(rootPane, "Erro ao inserir Desconto", "Mensagem de Erro", JOptionPane.ERROR_MESSAGE);
    ...
    private void preencheCampos() {
        ...
        cmbCliente.setSelectedItem(entidade.getCliente().getNome());
        txtValorTotal.setText(entidade.getValorTotal().toString());
        this.valorTotal = new BigDecimal(entidade.getValorTotal().toString());
    ...
    private void extraiCampos() throws ParseException {
        ...
        BigDecimal valorDesconto = new BigDecimal(txtDesconto.getText());
    ...
    private void limpaCampos() {
       ...
       txtdata.setText("");
       cmbCliente.setSelectedItem("Selecione");
    ...
    private boolean verificaCampos(){
        if(txtdata.getText().equals(""))
            return false;
        if(cmbCliente.getSelectedItem().equals("Selecione"))
            return false;
    ...
    public void abreInternalFrame(JInternalFrame frame) {
        ...
        TelaPrincipal.MenuPrincipal.setVisible(false);
