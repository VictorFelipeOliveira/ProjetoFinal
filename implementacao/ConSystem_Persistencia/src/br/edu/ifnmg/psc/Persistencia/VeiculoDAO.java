...
public class VeiculoDAO extends DAOGenerico<Veiculo> implements VeiculoRepositorio{
    ...
    public ArrayList<Veiculo> listarVeiculos() {
        ...
        String consulta = "select codigo, placa, tipo, ano, observacoes, combustivel, marca, modelo"
                + " from Veiculos";
        ...
        try{
            ...
            while(resultado.next()){
                ...
                veiculo.setPlaca(resultado.getString(2));
                veiculo.setTipo(resultado.getString(3));
                veiculo.setObservacoes(resultado.getString(4));
                veiculo.setCombustivel(resultado.getString(5));
                veiculo.setMarca(resultado.getString(6));
                veiculo.setModelo(resultado.getString(7));
